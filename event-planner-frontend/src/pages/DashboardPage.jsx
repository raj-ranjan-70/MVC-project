          ...
          <div className="space-y-4">
            {data?.recent_events.length > 0 ? (
              data.recent_events.map((event) => (
                <div key={event.id} className="glass-card p-6 rounded-2xl flex items-center justify-between group cursor-pointer hover:bg-white transition-colors">
                  ...
                  <div className="text-right">
                    <p className="text-xs font-bold uppercase tracking-wider text-primary bg-primary/5 px-3 py-1 rounded-full">{event.status}</p>
